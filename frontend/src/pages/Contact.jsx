...
const CUISINES = ['European', 'USA', 'African', 'Asia', 'Indian', 'Italian', 'Mediterranean', 'Latin American', 'Middle Eastern', 'Vegetarian', 'Vegan', 'Gluten-Free', 'Dessert', 'Quick & Easy', 'Healthy', 'Comfort Food'];
    ...
    return (
        <div className="w-full max-w-7xl mx-auto mt-24 px-4 sm:px-6 lg:px-8 space-y-10 pb-20 antialiased text-stone-900">
            ...
            <div className="flex flex-col items-center text-center space-y-6 max-w-2xl mx-auto">
                <h1 className="scroll-m-20 text-4xl font-bold tracking-tight text-balance text-primary">Explore Recipes</h1>
                ...
                <div className="flex flex-wrap justify-center gap-2 pt-2">
                    <Button
                        ...
                        className={`rounded-full text-xs font-semibold px-4 py-1.5 cursor-pointer transition ${
                            selectedCuisine === '' ? 'bg-primary text-white' : 'border-stone-200 text-stone-600 hover:bg-stone-50 hover:text-stone-700'
                        }`}
                    >
                        All Kitchens
                    </Button>
            ...
            <div className="border-t border-stone-200/60 pt-10">
                {loading ? (
                    <div className="text-center py-20 text-stone-400 font-medium">Searching our kitchen racks...</div>
                ) : posts.length === 0 ? (
                    <div className="text-center py-20 bg-stone-50 rounded-2xl border border-dashed border-stone-200">
                        <p className="text-stone-500 font-serif text-lg font-medium">No recipes match your criteria.</p>
                        <p className="text-xs text-stone-400 mt-1">Try adjusting your spelling keywords or selecting another cuisine tag.</p>
                    </div>
                ) : (
