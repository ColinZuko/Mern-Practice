    ...
    <div className="w-full max-w-6xl mx-auto mt-24 px-4 pb-20 antialiased text-stone-900">
      ...
      <div className="border-b border-stone-200 pb-4 mb-10">
        ...
        <p className="text-sm text-stone-500 mt-1">
          Publish your homemade recipe instructions, tips, and photography.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-5 gap-12 items-start">
        ...
        <form
          ...
          className="lg:col-span-3 space-y-8 bg-white border border-stone-200/60 p-8 rounded-3xl shadow-sm"
        >
          ...
          <div className="space-y-2">
            ...
            {!imagePreview ? (
              ...
              >
                <svg
                  className="w-8 h-8 text-stone-400 group-hover:text-primary transition"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span className="text-sm font-medium text-stone-600 group-hover:text-primary">
        ...
        <div className="lg:col-span-2 lg:sticky lg:top-28 space-y-4">
          <span className="text-xs font-bold uppercase tracking-widest text-stone-400 block px-1">
            Live Card Feed Preview
          </span>
            ...
            <div className="flex flex-col bg-white border border-stone-200/60 rounded-2xl p-4 shadow-sm space-y-4 pointer-events-none opacity-80">
              <div className="aspect-[16/10] w-full overflow-hidden bg-stone-100 rounded-xl relative">
                {imagePreview ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center bg-stone-200/60 text-xs text-stone-400">
                    No Snapshot Loaded
                  </div>
                )}
              </div>
              ...
              <div className="space-y-1">
                <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">
                  {title || "Untitled Recipe Header"}
                </h3>
                <p className="text-xs text-stone-500 line-clamp-2 min-h-8">
                  {description ||
                    "Your recipe description will show right here..."}
                </p>
              </div>
